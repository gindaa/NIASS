...
public class KasusDetailClass {
        private String idKasus;
        private String mTextnamafaskes;
        private String mTextAlamat;
        private String mTextrtrw;
        private String mTextKelurahan;
        private String mTextKecematan;
        private String mTextKabupaten;
    ...
    public void setmTextrtrw(String mTextrtrw) {
        this.mTextrtrw = mTextrtrw;
    }
    ...
    public void setmTextKecematan(String mTextKecematan) {
        this.mTextKecematan = mTextKecematan;
    }

    public void setmTextKabupaten(String mTextKabupaten) {
        this.mTextKabupaten = mTextKabupaten;
    }

    public String getmTextrtrw() {
    ...
    public String getmTextKecematan() {
        return mTextKecematan;
    }

    public String getmTextKabupaten() {
        return mTextKabupaten;
    }
    ...
    public KasusDetailClass(String idKasus, String mTextnamafaskes, String mTextAlamat, String mTextrtrw, String mTextKelurahan, String mTextKecematan, String mTextKabupaten, String mTextProvinsi, String mTextKota, String mTextregis, String mTextregisTbKota, String mTextNamaPasien, String mTextNik, String mtextjk, String mTextUmur, String mTextAlamat1, String mTextRujuk, String mTextdiagnosistb) {
